...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        ...
        <td>
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtSeccion" ErrorMessage="RegularExpressionValidator" Font-Bold="True" Font-Italic="True" ForeColor="Red" ValidationExpression="^([0-9])*$">El campo solo permite números.</asp:RegularExpressionValidator>
        </td>
    </tr>
    <tr>
